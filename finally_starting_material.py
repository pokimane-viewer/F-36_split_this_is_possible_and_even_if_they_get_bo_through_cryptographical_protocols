...
def f35_aircraft_cad(
    ...
    "Represents an exclusive design choice or configuration in geometry.
     ...
     or constraint set B (p ∧ ¬q), but not both or neither. Example: The wing
     attachment is either internal (¬p) and uses specific fasteners (q), OR it's
     external (p) and uses a different set of fasteners (¬q)."
    """
    # Fuselage
...
def reference_supply_chain_books():
    ...
    1. Flow: How the Best Supply Chains Thrive (2022) – Rob Handfield & Tom Linton
       - Focus: Supply chain continuity & resilience
       - Highlights post-pandemic frameworks, data & tech harnessing, and resilient supply networks.

    2. The New (Ab)Normal: Reshaping Business and Supply Chain Strategy Beyond Covid-19 (2020) – Yossi Sheffi
       - Focus: Supply chain strategy & risk management
       - Examines COVID-19 disruptions and how businesses adapt to a "new normal."

    3. Supply Chain Management For Dummies (3rd Edition) (2023) – Daniel Stanton
       - Focus: Comprehensive supply chain management (fundamentals & latest trends)
       - Updated post-COVID insights, advanced technologies, and risk mitigation.

    4. The Supply Chain Revolution (2023 reissue, orig. 2017) – Suman Sarkar
       - Focus: Sourcing strategies & competitive logistics
       - Real success stories (Apple, Zara) and modern best practices for strategic sourcing & distribution.

    5. Smart Manufacturing: The Lean Six Sigma Way (2022) – Anthony Tarantino
       - Focus: Digital manufacturing (Industry 4.0) & Lean/Six Sigma
       - Integration of IoT, robotics, AI, big data with lean methodology for operational excellence.

    6. Industry 4.0, Smart Manufacturing, and Industrial Engineering: Challenges and Opportunities (2024) – Amit Kumar Tyagi, Shrikant Tiwari, S. S. Ahmad (Eds.)
       - Focus: Advanced manufacturing systems (Industry 4.0 adoption)
       - Academic and practical coverage of integrating digital tech into manufacturing, with case studies.

    7. 《供应链管理（第7版）》 (2021) – [美] 苏尼尔·乔普拉 (Sunil Chopra) 等
       - Focus: Comprehensive SCM foundations (strategy to operations)
       - Chinese translation of a classic textbook, covering cost & service optimization, key performance drivers.

    8. 《智慧物流与智慧供应链》 (2020) – 霍艳芳, 齐二石 著
       - Focus: Smart logistics & supply chain (technology integration)
       - Discusses IoT, big data, AI for modernizing logistics in China’s intelligent manufacturing initiatives.

    9. 《供应链架构师：从战略到运营》 (2019) – 施云 著
       - Focus: Supply chain strategy & operations (practical playbook)
       - Case studies linking high-level strategy with day-to-day operations in China’s e-commerce era.

    10. 《智慧工业互联网》 (2019/2020) – 李伯虎, 柴旭东, 侯宝存 等
        - Focus: Industrial Internet & smart factory solutions
        - Aerospace industry cloud platform, merging industrial internet with AI and big data.

    These references collectively address continuity, resilience, risk management, digital transformation,
    and advanced manufacturing—insights that can inform real F-35 supply chain and manufacturing solutions.
    """
    # Placeholder function to hold the references in docstring form.
    # In a real system, this might parse or store references, but here we simply acknowledge them.
